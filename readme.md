...
Originally, in restricted/idealised test conditions 24% of its moves are random 
...
producing a sensible result.  In real gameplay, this means that the model will likely play a 
